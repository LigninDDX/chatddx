...
import json
from typing import TYPE_CHECKING, Any, Generic, TypeVar, cast, no_type_check
...
from repo.trail import TrailModel
...
def get_template_data(owner_name: str):
    payload: dict[str, Any] = {
        model: get_owned_trails(model, owner_name) for model in branch_map
    }
...
def get_branch_model(model_name: str, owner_name: str, data: dict[str, Any]):
...
class BranchModelAdmin(TypedModelAdmin[B]):
    name: str
