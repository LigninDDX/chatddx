...
from repo.admin.utils import truncate_content
...
from chatddx.django.repo.pydantic_ai.utils import get_part_content
from chatddx.django.repo.schemas import AgentSpec, MessageSpec
from chatddx.django.repo.trail.cache import trail_cache


class BranchModelProtocol(Protocol):
    name: str


class TrailProxy:
    def __str__(self: BranchModelProtocol) -> str:
        return self.name
